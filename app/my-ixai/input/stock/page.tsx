...
export const metadata = buildPublicMetadata({
  canonical: "/my-ixai/input/stock",
  description:
    "IXAI Workspace 股票與 ETF 輸入 foundation，預留股票、ETF 與未來 CSV / broker sync 流程。",
  title: "新增股票與 ETF | Asset Input Center",
});

export default function MyIxaiStockInputPage() {
  return (

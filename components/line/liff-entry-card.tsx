    ...
    <ShellCard className="border-[rgba(176,141,87,0.32)] bg-[rgba(255,250,240,0.86)]" tone="light">
        ...
        <div className="flex w-full flex-col gap-2 sm:w-56">
          ...
          {officialAccountUrl ? (
            <Link
              ...
              target="_blank"
            >
              <MessageCircle className="h-3.5 w-3.5 shrink-0 stroke-current text-[var(--ixai-gold)] opacity-100" aria-hidden="true" strokeWidth={2.25} />
      ...
      <div className="mt-5 rounded-lg border border-[var(--ixai-border)] bg-white/45 p-4">
        <div className="flex items-start gap-2 text-sm leading-6 text-[var(--ixai-forest-soft)]">
          <Sparkles className="mt-1 h-4 w-4 shrink-0 stroke-current text-[var(--ixai-gold)] opacity-100" aria-hidden="true" strokeWidth={2.25} />
          <p>

...
function buildSystemPrompt() {
  return [
    ...
    "Daily Brief 不是新聞列表；請先提出今天市場真正想解答的 central question，再用 key answer、evidence、counter evidence、watch next 回答。",
    "請用 News → Event → Signal → Central Question → Key Answer → Evidence → Counter Evidence → Watch Next → I-Xuan View 的思路產出內容。",
    "每段都必須回答：市場在問什麼、目前答案是什麼、證據在哪裡、反證在哪裡、下一步用什麼觀察驗證。",
  ...
  return JSON.stringify(
    {
      ...
      rules: [
        ...
        "MarketSummary should start with a central question and key answer, then connect macro, AI/Tech, Crypto and risk regime.",
        ...
        "Daily Intelligence should be question-first: central question, key answer, evidence, counter evidence, watch next, then source details.",
        "Do not summarize headlines directly; extract events, signals, central question, key answer, evidence, counter evidence, what changes my mind, and watch next.",
        "I-Xuan View must sound like a CIO / PM / asset allocator: explain what the market is selecting for, not what happened.",
        "Every narrative needs tension, why now, I-Xuan view, and observable watch next.",
        "Avoid analyst phrases: 市場訊號正在轉向, 投資人持續觀察, 風險偏好受到壓力, 值得關注, 持續關注, 市場情緒變化, 事件背後的市場訊號, AI敘事仍有吸引力.",

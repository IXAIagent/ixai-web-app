...
IXAI is designed as a Global Multi-Asset, Multi-Broker, Multi-Market AI Risk Platform. The product should be architected for US equities, Taiwan equities, Hong Kong equities, China A-Shares, Japan equities, Korea equities, European equities, Singapore equities, crypto assets, and FCN structured products.

Supported language direction includes Traditional Chinese (`zh-TW`), Simplified Chinese (`zh-CN`), English (`en-US`), Japanese (`ja-JP`), and Korean (`ko-KR`), with English (`en-GB`), French, and German future-ready.

All engines should remain market-agnostic. Valuation, Exposure, Concentration, Correlation, Scenario, Stress Test, FCN Risk, and future engines must not assume US-only, Taiwan-only, or English-only data. FCN underlyings may come from the United States, Hong Kong, China, Japan, Korea, Europe, Global Indexes, and future markets.

See `docs/GLOBAL_MARKET_VISION.md` for the canonical global market principle.
...
↓
Stress Test Engine Foundation
↓
FCN Risk Engine Foundation
↓
Portfolio Core Engine Foundation Complete
↓
Future Global Market Review / Real Market Data / Broker Sync
```

After v2.10a, the platform IA direction is:
...
The Portfolio Scenario Layer should translate valuation, exposure, concentration, and correlation readback into market-agnostic deterministic what-if scenarios. It should support future global markets and remain a monitoring layer, not a forecast, recommendation, or trading layer.

...
Current priority is `V15.0.1 Production Renderer Hung Hotfix`, a runtime stabilization pass after the V15 Workspace redesign merge. IXAI's product direction remains AI Wealth Workspace, but the immediate priority is production stability on `/my-ixai/home`, not new feature expansion, V16 planning, or further redesign.

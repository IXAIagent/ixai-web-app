...
Before continuing v3.00 UX / IA work, read `docs/LEGACY_PRO_MIGRATION_AUDIT_V211.md` and `docs/V300_UX_IA_FOUNDATION_PLAN.md`. Legacy Pro should remain reference-only: selected concepts may migrate, but legacy JWT login, localStorage token auth, direct browser-to-FastAPI protected requests, and the full legacy AppShell should not.
